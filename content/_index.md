        ...
        <div class="row homepage-welcome">
          ...
          <div class="col-12 col-md-9 homepage-welcome-copy-column">
            <div class="article-style homepage-welcome-copy">
              ...
              <p>We develop learning-based algorithms that allow autonomous systems to act competently in complex, uncertain environments. One key approach in this direction involves building and using world models (learned generative models of what a robot will observe next) for planning, simulation, and control. Our research is grounded in careful algorithm and objective design, drawing on ideas from imitation learning, reinforcement learning, generative modeling, and information theory, with applications spanning autonomous driving, robot navigation, manipulation, and beyond.</p>
